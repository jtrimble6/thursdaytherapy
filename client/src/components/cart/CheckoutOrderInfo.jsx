        ...
        return (
            <div className='checkoutFormRow orderInfoStep'>
              ...
              <div id="orderInfoTableDiv" hidden={this.props.cartLoaded ? false : true}>
                ...
                >
                  <Column flexGrow={1} minWidth={70} align="left">
