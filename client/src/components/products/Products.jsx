                ...
                <Grid fluid>
                  <Row className='show-grid'>
                    <Col className='productListingDetailsCol' xs={12} xsPush={12}>
                      ...
                      <textarea resize='none' rows={10} className='productsListingIngredients'>{ this.state.soapIngredients ? this.state.soapIngredients : 'No description listed' }</textarea>
                        <br />
